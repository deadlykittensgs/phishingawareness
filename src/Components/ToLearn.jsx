...
<div className=' pr-7 pl-7 pb-7 flex flex-col justify-center items-center text-center bg-slate-100'>
    ...
    <button  className='flex items-center gap-1 p-1 px-2 bg-[#0866FF]  text-white border-2 border-white rounded mt-2'><i className="fa-solid fa-share"></i> <p>Share</p> </button>
</div>
    </div>
    </div>
  )
